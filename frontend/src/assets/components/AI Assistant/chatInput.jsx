...
function ChatInput({ newMessage, isLoading, setNewMessage, submitNewMessage }) {
    ...
    return (
        <div className='sticky mb-20 bottom-0 shrink-0 py-4 center '>
            <div className='p-1.5 rounded-3xl z-50 font-mono origin-bottom animate-chat duration-400'>
                <div className='pr-0.5 bg-white fixed bottom-5 w-[50%] rounded-3xl overflow-hidden transition-all border border-indigo-300/20 focus-within:ring-2 focus-within:ring-indigo-500 focus-within:border-indigo-500'>
                    <textarea
