...
function ResNav() {
  ...
  return (
    <nav className="bg-white/90 backdrop-blur-sm fixed w-full z-20 top-0 start-0">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order" id="navbar-sticky">
          <ul className="flex flex-col p-4 md:p-0 mt-4 list-none font-medium border border-gray-200 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-transparent">
            ...
            <li>
              <Link to="#results" className="block py-2 px-3 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-indigo-600 md:p-0 no-underline">Results</Link>
            </li>
            <li>
              <Link to="#summary" className="block py-2 px-3 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-indigo-600 md:p-0 no-underline">AI Summary</Link>
            </li>
            <li>
              <Link to="#assistance" className="block py-2 px-3 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-indigo-600 md:p-0 no-underline">AI Assistance</Link>
            </li>
          </ul>
        </div>
      </div>
