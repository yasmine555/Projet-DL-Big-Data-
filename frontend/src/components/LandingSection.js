...
import dl from '../assets/deepl.png';
...
function LandingSection() {
  ...
  const handleUserTypeSelect = (userType) => {
    ...
    // Navigate to the input form page instead of the non-existent dashboard
    navigate('/input');
  };
      ...
      <div className="relative min-h-screen pt-20">
        ...
        <div className="container mx-auto px-6 py-16 bg-transparent" id="features">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            ...
            <div className="order-1 md:order-2 bg-white bg-opacity-80 p-6 rounded-xl">
